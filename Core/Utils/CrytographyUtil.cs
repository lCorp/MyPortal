...
namespace Core.Utils
{
    public class CrytographyUtil
    {
        ...
        private static readonly string PasswordHash = "P@ssW0rdH@sh#MyP0rt@l";
        private static readonly string SaltKey = "S@ltK3y#MyP0rt@l";
        private static readonly string VIKey = "My#P0rt@l";
